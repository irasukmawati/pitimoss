     ...
     <section class="content">
         ...
         <div class="card">
             <div class="card-header" style="background-color: #E4DEBE;">
                 <h3 class="card-title">Form Edit Detail Transaksi Penjualan</h3>
             ...
             <form action="" method="post">
                 <div class="card-body">
                     <input type="hidden" name="kode_detail" value="<?= $detailtransaksi['kode_detail'] ?>" />
                     <div class="form-group">
                         <label for="kode_detail">Kode Detail</label>
                         <input type="text" class="form-control" id="kode_detail" name="kode_detail" placeholder="Enter Kode Detail" value="<?= $detailtransaksi['kode_detail'] ?>" required>
                     </div>
                     <div class="form-group">
